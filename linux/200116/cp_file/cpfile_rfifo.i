...
{
 int infd = open("tp", 
# 18 "cpfile_rfifo.cpp" 3 4
                      00
# 18 "cpfile_rfifo.cpp"
                              );
 if(infd == -1)
 {
  do{perror("open_tp");exit(
# 21 "cpfile_rfifo.cpp" 3 4
 1
# 21 "cpfile_rfifo.cpp"
 );}while(0);
 }
 int outfd = open("file.bak", 
# 23 "cpfile_rfifo.cpp" 3 4
                             01
# 23 "cpfile_rfifo.cpp"
                                     |
# 23 "cpfile_rfifo.cpp" 3 4
...
# 23 "cpfile_rfifo.cpp"
 ...
 if(outfd == -1)
 {
  do{perror("open_file_bak");exit(
# 26 "cpfile_rfifo.cpp" 3 4
 1
# 26 "cpfile_rfifo.cpp"
 );}while(0);
 }
