...
{
 int infd = open("file", 
# 23 "cpfile_wfifo.cpp" 3 4
                        00
# 23 "cpfile_wfifo.cpp"
                                );
 if(infd == -1)
 {
  do{perror("open_file");exit(
# 26 "cpfile_wfifo.cpp" 3 4
 1
# 26 "cpfile_wfifo.cpp"
 );}while(0);
 }
 int outfd = open("tp", 
# 28 "cpfile_wfifo.cpp" 3 4
                       01
# 28 "cpfile_wfifo.cpp"
                               );
 if(outfd == -1)
